...
* **P/L Equivalent (Total Volume per Ticker):**
    ![P/L Trend](../../samples/Sample_6_Market_Stock_Flow/readme_plots/000_0_1__PL_Trend.png)
* **B/S Equivalent (Unbalanced Stock Accumulation):**
    ![B/S Trend](../../samples/Sample_6_Market_Stock_Flow/readme_plots/000_0_1__BS_Trend.png)
...
* **Network Topology 5-Point Sequence:**
  * **① Start (t=0 / 2020-W01):**
        ![Topology t0](../../samples/Sample_6_Market_Stock_Flow/readme_plots/002_1_2__network_topology.t.00000.png)
  ...
  * **② Just Before Change (t=38 / 2020-W39):**
        ![Topology t38](../../samples/Sample_6_Market_Stock_Flow/readme_plots/002_1_2__network_topology.t.00038.png)
  ...
  * **③ The Exact Point of Change (t=39 / 2020-W40):**
        ![Topology t39](../../samples/Sample_6_Market_Stock_Flow/readme_plots/002_1_2__network_topology.t.00039.png)
  ...
  * **④ Immediately After Change (t=40 / 2020-W41):**
        ![Topology t40](../../samples/Sample_6_Market_Stock_Flow/readme_plots/002_1_2__network_topology.t.00040.png)
  ...
  * **⑤ End (t=51 / 2020-W52):**
        ![Topology t51](../../samples/Sample_6_Market_Stock_Flow/readme_plots/002_1_2__network_topology.t.00051.png)
...
* **Eigenvector Evolution:**
    ![Eigenvector Evolution](../../samples/Sample_6_Market_Stock_Flow/readme_plots/000_2_3__eigenvector_evolution.png)
...
* **Specific Intervention Plan:**
    ...
    2. **Acupoint Account Freezing based on LQR Sensitivity:**
       Apply temporary trading limits (limit orders with enhanced verification) to the accounts `USR_003` and `USR_004` acting as the hubs of recirculation. This surgically cuts out the pathological attractor without disrupting the normal orders of other investors.
        ![LQR Performance Space](../../samples/Sample_6_Market_Stock_Flow/readme_plots/004_1_3__control_lqr_performance_space.png)
