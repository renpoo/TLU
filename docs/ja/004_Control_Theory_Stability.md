...
- [介入感度行列](#4-介入感度行列-004_2_1__sensitivity_matrixpng)
...
![Sample 6 LQR Space](../../samples/Sample_6_Market_Bipartite_Weekly/readme_plots/004_1_3__control_lqr_performance_space.png)

#### 🟡 Sample 7 (市場資金移動)
**臨床解説:**
直接送金還流ループのコア結節点である `02_USR_003` および `03_USR_004` ノードに感度極大値（**`41.5234`**）が検出され、この共謀 syndicate 介入の急所を特定しています。
![Sample 7 LQR Space](../../samples/Sample_7_Market_Users_Weekly/readme_plots/004_1_3__control_lqr_performance_space.png)
