...
* **【🔴 本サンプルの異常状態】**
![Z-Score 3D Surface](../../../../samples/Sample_8_fMRI_Stroke/plots/002_2_2_2__3d_micro_z_score_X.png)
* **💡 可視化グラフの読解の仕方（Visual Cues）:**
  ...
  * **🔴 本サンプルの異常:** 3D Surface 上で、極端に明るい黄色（Yellow）で発光している孤立したセルを探してください。これが、数学的特異点（物理的な血栓/閉塞）の正確な空間座標をピンポイントで示しています。
