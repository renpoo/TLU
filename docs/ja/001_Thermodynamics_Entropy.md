...
![Sample 6 Energy Stack](../../samples/Sample_6_Market_Bipartite_Weekly/readme_plots/001_1_2__thermodynamics_energy_stack.png)

#### 🟡 Sample 7 (市場資金移動)
**臨床解説:**
共謀口座間の閉じた直接送金ループにより、共謀取引の活発化に伴って摩擦熱損失（$TS$）が急膨張し、システム全体の資金効率（自由エネルギー）が強く削り取られています。
![Sample 7 Energy Stack](../../samples/Sample_7_Market_Users_Weekly/readme_plots/001_1_2__thermodynamics_energy_stack.png)
