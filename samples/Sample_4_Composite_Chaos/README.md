...
* **Start (t=0 / 2020-01):** ![Topology t0](readme_plots/002_1_2__network_topology.t.00000.png) (Formation of closed recirculation loop)
* **Just Before Change (t=4 / 2020-05):** ![Topology t4](readme_plots/002_1_2__network_topology.t.00004.png) (Thickening of recirculation paths)
* **Onset of Leak (t=5 / 2020-06):** ![Topology t5](readme_plots/002_1_2__network_topology.t.00005.png) (Manifestation of bypass path to `UNKNOWN_LEAK`)
* **Peak Leak / Immediately After Change (t=8 / 2020-09):** ![Topology t8](readme_plots/002_1_2__network_topology.t.00008.png) (Opening of thick drainage edge to `UNKNOWN_LEAK`)
* **End (t=11 / 2020-12):** ![Topology t11](readme_plots/002_1_2__network_topology.t.00011.png) (Final necrotic topology with permanently distorted connections)
...
2. **Falsification Proof for Mass Deficit:**
    ...
    * **2020-06-04:** [E_001403](input_stream/Dummy_Journal_Stream.csv#L2806-L2807) (A/R decrease `$130.55` / Cash increase `$0.00`)
    * **2020-07-13:** [E_001725](input_stream/Dummy_Journal_Stream.csv#L3450-L3451) (A/R decrease `$279.78` / Cash increase `$0.00`)
    * **2020-07-25:** [E_001859](input_stream/Dummy_Journal_Stream.csv#L3718-L3719) (A/R decrease `$362.39` / Cash increase `$0.00`)
    * **2020-08-07:** [E_002002](input_stream/Dummy_Journal_Stream.csv#L4004-L4005) (A/R decrease `$861.39` / Cash increase `$509.57`; difference `$351.82`)
    * **2020-08-17:** [E_002126](input_stream/Dummy_Journal_Stream.csv#L4252-L4253) (A/R decrease `$477.53` / Cash increase `$394.49`; difference `$83.04`)
    * **2020-08-19:** [E_002154](input_stream/Dummy_Journal_Stream.csv#L4308-L4309) (A/R decrease `$274.84` / Cash increase `$0.00`)
    * **2020-09-09:** [E_002432](input_stream/Dummy_Journal_Stream.csv#L4864-L4865) (Cash decrease `$4,534.35` / A/P decrease `$0.00`)
    * **2020-09-10:** [E_002437](input_stream/Dummy_Journal_Stream.csv#L4874-L4875) (A/R decrease `$460.76` / Cash increase `$304.22`; difference `$156.54`)
    * **2020-09-22:** [E_002575](input_stream/Dummy_Journal_Stream.csv#L5150-L5151) (A/R decrease `$82.68` / Cash increase `$0.00`)
