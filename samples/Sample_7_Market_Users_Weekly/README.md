...
By discarding the intermediate ticker nodes and tracking only the moving paths of capital (mass), the physics engine exposes the core of the collusive syndicate (matched order loop):
