...
**Target Environment:** `samples/Sample_15_Unbalanced_Raw`
**Date Analyzed:** 2026-05-15 09:08:28
...
- **Severity:** CRITICAL
- **Evidence:** Kurtosis: 940.63, Anomalies (Z>3): 4 times.
...
- **Severity:** CRITICAL
- **Evidence:** Min Edge Stress: 0.0000.
...
- **Severity:** CRITICAL
- **Evidence:** Relative Leak Ratio: 0.000243.
...
### Entropy (S) Dynamics
- **Baseline (Mean / Median):** 0.00 / 0.00
- **Volatility (Std Dev):** 0.03
- **Distribution Shape (Skew / Kurtosis):** 30.35 / 940.63
- **Anomaly Count (Z > 3.0):** 4 times

### Free Energy (F) Dynamics
- **Baseline (Mean / Median):** 3,200,702.74 / 3,205,105.46
- **Volatility (Std Dev):** 572,532.42
- **Distribution Shape (Skew / Kurtosis):** -0.20 / -1.08
- **Anomaly Count (Z > 3.0):** 0 times

### Topological & Conservation Constraints
- **Max Spectral Radius:** 0.0000
- **Min Edge Stress:** 0.0000
- **Relative Mass Leak Ratio:** 0.000243

## 3. Structural Evolution (Viscosity Classification)

- **Viscosity Range:** `200151.39 ~ 410484.05`
