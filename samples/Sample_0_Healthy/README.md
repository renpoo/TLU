...
* **Physical Evidence:** 
  ...
  ![Micro Z-Score Heatmap](readme_plots/002_2_2_2__micro_Z_Score_heatmap.png)
...
**【Action Plan】**
Instruct the procurement and inventory management departments to conduct an immediate physical inventory count and reconcile the `ACC_Inventory` ledger. Correct the data entry omission (missing purchase journals) that is artificially driving the inventory balance below zero.
