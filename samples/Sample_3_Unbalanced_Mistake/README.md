...
* **Physical Evidence:**
  * **Relative Mass Leak Ratio:** **0.0116** (Exceeds the 0.001 threshold by more than 10x). Over 1% of the total systemic transaction volume is appearing or disappearing from nowhere.
  ![002_2_1__macro_forensics_dashboard 2](../../samples/Sample_0_Healthy/readme_plots/002_2_1__macro_forensics_dashboard.png)
  * **💡 How to Read the Graph (Visual Cues):** Look at the Z-Score line. A spike exceeding 2.0 or 3.0 indicates a violation of mass conservation. Here, it spikes astronomically, proving that the basic accounting equation (Debits = Credits) was physically broken.
...
* **Thermodynamic Energy Depletion (Free Energy: -0.1263):**
  ...
  * **💡 How to Read the Graph (Visual Cues):** Look at the white Free Energy line. Because mass is leaking into the void, the system's capacity to do work plummets, visualizing exactly like severe embezzlement.
...
* **Topological Stability (Max Spectral Radius: 0.000):**
  ...
  * **💡 How to Read the Graph (Visual Cues):** The blue line stays completely flat at 0.0, far below the red 1.0 threshold. This visually proves no loops exist—the money is simply disappearing in a straight line.
