...
**Target Environment:** `samples/Sample_11_US_Macro`
**Date Analyzed:** 2026-05-16 11:18:41
...
- **Severity:** CRITICAL
- **Evidence:** Kurtosis: 221.22, Anomalies (Z>3): 2 times.
...
- **Severity:** HIGH
- **Evidence:** Entropy Skewness: -14.45.
...
- **Severity:** CRITICAL
- **Evidence:** Min Edge Stress: 0.0931.
...
### Entropy (S) Dynamics
- **Baseline (Mean / Median):** -0.44 / 0.17
- **Volatility (Std Dev):** 7.72
- **Distribution Shape (Skew / Kurtosis):** -14.45 / 221.22
- **Anomaly Count (Z > 3.0):** 2 times

### Free Energy (F) Dynamics
- **Baseline (Mean / Median):** 242.89 / 193.64
- **Volatility (Std Dev):** 392.30
- **Distribution Shape (Skew / Kurtosis):** 9.60 / 121.64
- **Anomaly Count (Z > 3.0):** 3 times

### Topological & Conservation Constraints
- **Max Spectral Radius:** 0.0000
- **Min Edge Stress:** 0.0931
- **Relative Mass Leak Ratio:** 0.000000

## 3. Structural Evolution (Viscosity Classification)

- **Viscosity Range:** `11.09 ~ 48.37`
  - 🟢 **Diagnosis:** Standard systemic viscosity.
