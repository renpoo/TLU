...
Extracting [Dummy_Journal_Stream.csv](input_stream/Dummy_Journal_Stream.csv) directly confirms that the above three entries are executed at the exact same timesteps with identical amounts (noise-free exact matching):
...
* **① 3D Dynamics Position / Phase Space Trajectory:**
    ![3D Dynamics Position](readme_plots/000_1_1__3d_dynamics_position.png)
