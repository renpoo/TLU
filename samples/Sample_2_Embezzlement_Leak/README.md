...
The Physics-Mathematics-Mathematics Engine corrects for this "disappearing mass" mathematically to maintain a dynamic closed system, constructing a virtual garbage-bin node **`UNKNOWN_LEAK`** in memory and routing the lost mass there. Below we prove how this causes dynamic anomalies.
...
* **Network Topology 5-Point Sequence:**
  ...
  * **② Just Before Change (t=1 / 2020-02):**
        ![Topology t1](readme_plots/002_1_2__network_topology.t.00001.png)
        The first leakage occurs, connecting the `UNKNOWN_LEAK` node to the topological space, and funds begin to drain.
  * **③ The Exact Point of Change (t=2 / 2020-03):**
        ![Topology t2](readme_plots/002_1_2__network_topology.t.00002.png)
