...
python3 -m src.filters._0_1_preprocess_weekly_summary < workspace/input_stream/Dummy_Journal_Stream_Amount.csv > workspace/input_stream/Dummy_Journal_Stream_Amount.Aggregated.csv
