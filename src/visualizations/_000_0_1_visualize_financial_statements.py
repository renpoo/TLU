...
def draw_bs_block_chart(report, out_path):
    fig, ax = plt.subplots(figsize=(8, 6))
    
    assets = [item for item in report['bs_items'] if item[1] == 'Asset']
    liabs = [item for item in report['bs_items'] if item[1] == 'Liability']
...
def draw_pl_waterfall(report, out_path):
