...
# 1. Read data
df = pd.read_csv(f"{env_dir}/input_stream/Dummy_Kyoto_Traffic_Journal_Amount.csv")
...
df_monthly.to_csv(f"{env_dir}/input_stream/Dummy_Kyoto_Traffic_Journal_Aggregated.csv", index=False, encoding="utf-8")
