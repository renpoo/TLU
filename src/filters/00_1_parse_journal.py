#!/usr/bin/env python3
# ==========================================
# 00_1_parse_journal.py
# TLU System: Pre-processing Phase 0
# Category: Raw Journal Parser (Thin Adapter to COO Stream)
# Version: 6.0.0 (Refactored Stream Adapter)
# ==========================================
"""
@file 00_1_parse_journal.py
@brief TLU Pre-processing Phase 0: Parses raw double-entry accounting journals into standard COO stream.
"""
