...
| **3** | **[📂 03. Market Forensics & Compliance Rules](scratch/03_Market_Forensics_Rules_EN.md)** | **[JA Link (Compliance Rules)](scratch/03_Market_Forensics_Rules.md)** | Covers orderbook mechanics, USR circular trades, and network collusion auditing via user cash/stock flow graphs. |
| **4** | **[📂 LLM Diagnostic Manual (Supreme prompt)](docs/LLM_Diagnostic_Manual.md)** | **[JA Link (LLM Manual)](docs/ja/LLM_Diagnostic_Manual.md)** | System prompt for LLM meta-diagnosis. It contains protocols to generate clinical reports and verify data facts. |
| **5** | **[📂 Verified Sample Registry & Catalog](docs/samples/README.md)** | **[JA Link (Catalog)](docs/ja/samples/README.md)** | Catalog of the 10 validation samples. It lists detection parameters, parameter thresholds, and LQR intervention guides. |
